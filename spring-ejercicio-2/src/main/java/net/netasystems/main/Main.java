...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext context = new ClassPathXmlApplicationContext("applicationContext.xml");//aplicando en contexto 
        ...
        System.out.println("El programador #1 lo hace en: "+prgm1.hackTheWorld());//llama el metod con la creacion desde el XML 
